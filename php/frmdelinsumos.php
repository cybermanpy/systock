...
<section class="container">
    ...
    <section class="content">
      <?php
      $pk=$_GET['pk'];
      $table1='insumos i, desinsumos di, tipos t ';
      $table='insumos';
      $array=array('pkinsumo','desinsumo','destipo');
      $sql=select($table1,$array);
      $sql.=" WHERE pkinsumo='".$pk."' AND i.fkdesinsumo=di.pkdesinsumo AND di.fktipo=t.pktipo ";
      $res = connector2($sql);
      $row=fetchArray($res);
      $rows=getNumRows($res);
      $pkt='pkinsumo';
