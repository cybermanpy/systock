...
<section class="container">
    ...
    <section class="content">
      <?php
      $pk=$_GET['pk'];
      $table1='insumos_aprov i, desinsumos di, tipos t ';
      $table='insumos_aprov';
      $array=array('pkinsumoapro','desinsumo','destipo');
      $sql=select($table1,$array);
      $sql.=" WHERE pkinsumoapro='".$pk."' AND i.fkdesinsumo=di.pkdesinsumo AND di.fktipo=t.pktipo ";
      $res = connector2($sql);
      $row=fetchArray($res);
      $rows=getNumRows($res);
      $pkt='pkinsumoapro';
      ...
      <table>
        <tr>
        	<th colspan="2">Borrar Insumo Aprovicionamiento</th>
        </tr>
        <tr>
          <td>PK </td>
